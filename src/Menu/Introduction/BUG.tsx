    ...
    },
    {
        ...
        content:
            <div>
                ...
                <br />我在汉化插件分栏预留了一份基于Sybaris的汉化解码整合包，可以借此满足基本的游戏需求，其他插件就需要自行安装了。提示：CMI只是一个整合包，里面大部分插件Sybaris也是可以使用的。
                <br />目前有部分网友表示该问题已解决，其解决方式如下，具体是否有效我无法测试：
                <ol>
                    <li>
                        更换了游戏版本，2023终极版本体似乎没这个问题。
                    </li>
                    <li>重新用国外下载器下载，确保了所有文件真的无缺损。</li>
                </ol>
            </div>
    },
    {
